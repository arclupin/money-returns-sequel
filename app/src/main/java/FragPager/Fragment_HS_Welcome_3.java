...
public class Fragment_HS_Welcome_3 extends Fragment {


//public static Fragment_HS_Welcome_3 getFragment_HS_Welcome_1(int layout) {
//        Fragment_HS_Welcome_3 f = new Fragment_HS_Welcome_3();
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle saveInstance) {
        ...
        View view = inflater.inflate(R.layout.fragment_hs_welcome_3, parent, false);
        TextView textView = (TextView) view.findViewById(R.id.Welcome_HS_3_TextView);
...
//        Toast.makeText(this.getActivity(), textView.getText(), Toast.LENGTH_SHORT).show();
        Log.d("view height", Integer.toString(this.getActivity().findViewById(R.id.HS_Welcome_Slider).getHeight()));
